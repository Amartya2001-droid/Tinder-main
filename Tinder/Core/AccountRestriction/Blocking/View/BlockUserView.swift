    ...
    var body: some View {
        VStack {
            ...
            VStack(alignment: .leading, spacing: 24) {
                AccountRestrictionInfoItemView(imageName: "exclamationmark.bubble", description: "They won't be able to message you or find your profile or content on HeartSync.")
            ...
            Button { onBlockTapped() } label: {
                Text("Block")
                    .modifier(HeartSyncButtonModifier())
            }
        }
